    ...
    if broken:
        print(
            colored(
                ...
                "Re-link each one with `C:\\Users\\Administrator\\AppData\\Local\\Programs\\Python\\Launcher\\py.exe -3 .trellis/scripts/task.py "
...
def cmd_create(args: argparse.Namespace) -> int:
    ...
    if created_jsonl:
        ...
        print(
            "      list available specs: C:\\Users\\Administrator\\AppData\\Local\\Programs\\Python\\Launcher\\py.exe -3 .trellis/scripts/get_context.py --mode packages",
            file=sys.stderr,
        )
...
def _validate_branch_metadata(
    ...
    task_py = f"C:\\Users\\Administrator\\AppData\\Local\\Programs\\Python\\Launcher\\py.exe -3 {DIR_WORKFLOW}/scripts/task.py"
...
def cmd_set_branch(args: argparse.Namespace) -> int:
    ...
    if not branch:
        ...
        print("Usage: C:\\Users\\Administrator\\AppData\\Local\\Programs\\Python\\Launcher\\py.exe -3 task.py set-branch <task-dir> <branch-name>")
        return 1
...
def cmd_set_base_branch(args: argparse.Namespace) -> int:
    ...
    if not base_branch:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: C:\\Users\\Administrator\\AppData\\Local\\Programs\\Python\\Launcher\\py.exe -3 task.py set-base-branch <task-dir> <base-branch>")
        print("Example: C:\\Users\\Administrator\\AppData\\Local\\Programs\\Python\\Launcher\\py.exe -3 task.py set-base-branch <dir> develop")
        print()
...
def cmd_set_scope(args: argparse.Namespace) -> int:
    ...
    if not scope:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: C:\\Users\\Administrator\\AppData\\Local\\Programs\\Python\\Launcher\\py.exe -3 task.py set-scope <task-dir> <scope>")
        return 1
...
def cmd_set_meta(args: argparse.Namespace) -> int:
    ...
    if not key:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: C:\\Users\\Administrator\\AppData\\Local\\Programs\\Python\\Launcher\\py.exe -3 task.py set-meta <task-dir> <key> <value>")
        return 1
