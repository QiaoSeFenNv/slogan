#!/usr/bin/env python3
r"""Linear sync hook for Trellis task lifecycle.

Syncs task events to Linear via the `linearis` CLI.

Usage (called automatically by task.py hooks):
    C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 .trellis/scripts/hooks/linear_sync.py create
    C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 .trellis/scripts/hooks/linear_sync.py start
    C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 .trellis/scripts/hooks/linear_sync.py archive

Manual usage:
    TASK_JSON_PATH=.trellis/tasks/<name>/task.json C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 .trellis/scripts/hooks/linear_sync.py sync
