...
Usage:
    C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 add_session.py --title "Title" --commit "hash" --summary "Summary" [--package cli]
    C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 add_session.py --title "Title" --branch "feat/my-branch"

    # Pipe detailed content via stdin (use --stdin to opt in):
    cat << 'EOF' | C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 add_session.py --stdin --title "Title" --summary "Summary"
    <session content here>
    EOF

    # Structured content (repeatable; a section with no bullets is omitted):
    C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 add_session.py --title "Title" --change "Did X" --test "Ran Y" --next-step "Do Z"
    ...
    C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 add_session.py --title "Title" --commit "abc1234" \
