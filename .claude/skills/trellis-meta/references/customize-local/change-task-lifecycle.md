...
hooks:
  after_create:
    - "C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 .trellis/scripts/hooks/my_sync.py create"
  after_start:
    - "C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 .trellis/scripts/hooks/my_sync.py start"
  after_finish:
    - "C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 .trellis/scripts/hooks/my_sync.py finish"
  after_archive:
    - "C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 .trellis/scripts/hooks/my_sync.py archive"
```
...
1. Confirm the current task with `C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py current --source`.
