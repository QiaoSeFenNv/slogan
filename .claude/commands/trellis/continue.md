...
```bash
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/get_context.py
```
...
```bash
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/get_context.py --mode phase
```
...
```bash
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/get_context.py --mode phase --step <X.X> --platform claude
```
