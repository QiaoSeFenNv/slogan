...
To get structured package info, run: `C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./{DIR_WORKFLOW}/scripts/get_context.py --mode packages`
