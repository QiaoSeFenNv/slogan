...
```bash
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py add-context <task> implement ".trellis/spec/webapp/security/index.md" "Security conventions"
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py add-context <task> check ".trellis/spec/webapp/security/index.md" "Security review rules"
```
