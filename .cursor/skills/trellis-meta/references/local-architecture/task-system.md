...
```bash
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py create "<child title>" --description "<one-line summary>" --slug <child-slug> --parent <parent-dir>
```

Link or unlink existing tasks with:

```bash
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py add-subtask <parent-dir> <child-dir>
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py remove-subtask <parent-dir> <child-dir>
```
...
```bash
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py create "<title>" --description "<one-line summary>" --slug <slug>
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py start <task>
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py current --source
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py add-context <task> implement <file> <reason>
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py validate <task>
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py finish
C:\Users\Administrator\AppData\Local\Programs\Python\Launcher\py.exe -3 ./.trellis/scripts/task.py archive <task>
```
